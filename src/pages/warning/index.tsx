      ...
      <div className={styles.content_container}>
        <div className={styles.content_wrapper}>
          <div className={styles.title}>
            <div className={styles.main_text}>XLetter의 첫걸음에 관심을 가져 주신 모든 분들 감사합니다!🙇‍♀️</div>
            <div className={styles.sub_text}>테스트에 참여하기에 앞서 몇 가지 안내드릴 사항이 있어요.</div>
          </div>
            ...
            <div className={styles.warn_container}>
              <div className={styles.item}>
                ...
                <div className={styles.item_text}>
                  ...
                  <div className={styles.text_gray}>가능하면 모바일이 아닌 PC로 접속해 주세요. </div>
                </div>
              </div>
              <div className={styles.item}>
                <div className={styles.number}>2</div>
                <div className={styles.item_text}>
                  <div className={styles.text}>글 중간에 분기점이 존재하는 인터랙티브 웹소설이에요.</div>
                  <div className={styles.text_gray}>
                    당황하지 마시고 두 가지 선택지 중 한 가지를 골라 주세요. 선택의 기회는 단 한 번이랍니다.
                  </div>
              ...
              <div className={styles.item}>
                ...
                <div className={styles.item_text}>
                  <div className={styles.text}>테스터님의 평가를 기다리고 있어요.</div>
                  <div className={styles.text_gray}>
                    모두 읽으신 후 설문에 참여해 주세요. 지갑 주소를 입력하면 에어드랍 이벤트에 자동으로 참여됩니다.
                  </div>
                </div>
              </div>
            </div>
